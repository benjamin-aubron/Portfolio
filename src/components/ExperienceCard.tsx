    ...
    <div className="pb-2">
      <AccordionTrigger className="">
        <div className="flex items-center justify-start w-full">
          <div className="flex flex-0 items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-md bg-[--primaryColor]">
          ...
          <div className="flex flex-1 justify-between ml-3 text-neutral-200 text-base md:text-xl font-semibold">
            <div>
      ...
      <AccordionContent>
        <div className="flex items-center justify-start pb-2 text-base">
          <div className="min-w-[2px] mx-[19px] md:mx-[23px] bg-[--secondaryColor] self-stretch rounded"></div>        
          <div className="ml-3">
