  ...
  return (
    <div className='relative max-w-screen-xl mx-auto px-4 h-screen'>
      <div>
        ...
        <h2 className='text-neutral-500 text-base md:text-5xl font-semibold max-w-screen-lg py-4 lg:py-6'><span className='text-neutral-100'>Next.js Front-end Engineer.</span> Huge interest in building things. I'm looking for new challenges.</h2>
        <div className='text-neutral-400 text-xs md:text-3xl font-medium py-12'>👩🏻‍💻 Currently specializing in Frontend (React / Next)</div>
        <div className="flex flex-wrap items-center justify-start gap-3 md:gap-6 text-neutral-100 pt-4">
          <a href="" className='flex items-center gap-2 bg-neutral-900 hover:bg-neutral-800 rounded-lg py-2 px-2.5 md:px-4 text-xs md:text-xl font-semibold'>
