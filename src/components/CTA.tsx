  ...
  return (
    <div className='relative max-w-screen-xl mx-auto px-4'>
      <div>
        ...
        <h1 className='text-neutral-100 font-extrabold text-5xl md:text-7xl py-4 lg:py-10'>Benjamin AUBRON</h1>
        <h2 className='text-neutral-500 text-base md:text-4xl font-semibold max-w-screen-md py-4 lg:py-6'><span className='text-neutral-100'>Next.js Front-end Engineer.</span> Huge interest in building things. I'm looking for new challenges.</h2>
        <div className='text-neutral-400 text-xs md:text-2xl font-medium py-4'>👩🏻‍💻 Currently learning Nuxt.js</div>
