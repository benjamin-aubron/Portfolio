...
export default function CTA() {
  return (
    <div id="home" className='relative max-w-screen-xl mx-auto pt-20 px-6 h-screen'>
      <div>
        <div className='text-[--primaryColorDark] text-2xl md:text-4xl font-semibold pt-20'>Hey 👋 ! Je suis</div>
        <h1 className='text-neutral-100 font-extrabold text-6xl md:text-8xl pt-0 py-4 lg:py-10'>Benjamin AUBRON</h1>
        <h2 className='text-neutral-500 text-2xl md:text-5xl font-semibold max-w-screen-lg py-4 lg:py-6'><span className='text-neutral-100'>Développeur Front-end avec Next.js</span>. A la recherche de nouveaux challenges.</h2>
        <div className='text-neutral-400 text-lg md:text-3xl font-medium py-12'>👩🏻‍💻 Me perfectionnant actuellement en Frontend (React / Next)</div>
