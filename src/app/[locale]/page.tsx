  ...
  return (
    <div className="bg-black overflow-hidden">
      ...
      <section id="project" className="bg-black max-w-screen-xl mx-auto px-4 pt-32 pb-40 text-neutral-100">
        <h2 className="text-4xl text-neutral-100 font-semibold pb-6">{t1("projet")}</h2>
      ...
      <section id="skills" className="bg-black max-w-screen-lg mx-auto px-4 py-32 text-neutral-100">
        <h2 className="text-4xl text-neutral-100 font-semibold pb-6">{t1("skill")}</h2>
        <SkillsTabs />
      </section>

      <section id="stack" className="bg-black max-w-screen-lg mx-auto px-4 py-32 text-neutral-100">
        <h2 className="text-4xl text-neutral-100 font-semibold pb-6">{t1("stack")}</h2>
      ...
      <section id="timeline" className="bg-black max-w-screen-lg mx-auto px-4 py-32 text-neutral-100">
        <h2 className="text-4xl text-neutral-100 font-semibold pb-6">{t1("timeline")}</h2>
      ...
      <section id="about" className="bg-black max-w-screen-lg mx-auto px-4 py-32 text-neutral-100">
        <h2 className="text-4xl text-neutral-100 font-semibold pb-6">{t1("about")}</h2>
        <div className="flex flex-col lg:flex-row items-center justify-between gap-20 lg:gap-10">
          <div>
            <div className="leading-8 py-2">{t2("about1")} <span className="py-[3px] px-2 bg-neutral-950 border border-neutral-800 rounded-md whitespace-nowrap">
              ...
              </span>. {t2("about2")} <span className="py-[3px] px-2 bg-neutral-950 border border-neutral-800 rounded-md whitespace-nowrap"><img src="web3.png" alt="blockchain network" className="inline items-center h-5 pb-1 mr-2"/>{t2("about3")}</span>. {t2("about4")} <a href="https://github.com/dataforgoodfr/13_eclaireur_public" target="_blank" className="hover:underline text-[--secondaryColor] hover:text-[--primaryColor]">@éclaireur public</a>.</div>
            <div className="leading-8 py-2">{t2("about5")}<span className="py-[3px] px-2 bg-neutral-950 border border-neutral-800 rounded-md whitespace-nowrap"><img src="geopolitique.png" alt="earth" className="inline items-center h-5 pb-1 mr-2"/>{t2("about6")}</span>, <span className="py-[3px] px-2 bg-neutral-950 border border-neutral-800 rounded-md whitespace-nowrap"><img src="economie.png" alt="coin" className="inline items-center h-5 pb-1 mr-2"/>{t2("about7")}</span> {t2("about7a")} <span className="py-[3px] px-2 bg-neutral-950 border border-neutral-800 rounded-md whitespace-nowrap"><img src="sociologie.png" alt="social network" className="inline items-center h-5 pb-1 mr-2"/>{t2("about8")}</span></div>  
            <div className="leading-8 py-2">{t2("about9")}<span className="py-[3px] px-2 bg-neutral-950 border border-neutral-800 rounded-md whitespace-nowrap"><img src="cuisine.png" alt="chef hat" className="inline items-center h-5 pb-1 mr-2"/>{t2("about10")}</span>{t2("about11")}<span className="py-[3px] px-2 bg-neutral-950 border border-neutral-800 rounded-md whitespace-nowrap"><img src="badminton.png" alt="badminton racket" className="inline items-center h-5 pb-0.5 mr-2"/>badminton</span> {t2("about12")}<span className="py-[3px] px-2 bg-neutral-950 border border-neutral-800 rounded-md whitespace-nowrap"><img src="donsang.png" alt="Blood drop" className="inline items-center h-5 pb-1 mr-1"/>{t2("about13")}</span>.</div>
          </div>
      ...
      <section className="bg-black max-w-screen-lg mx-auto px-4 pt-20 pb-80 text-neutral-100">
        <h2 className="text-neutral-100 text-5xl text-center font-bold pb-4">{t3("contact")}</h2>
        <div className="text-center text-xl pt-8">{t3("job")} <span className="text-[--primaryColor] ">Next.js</span></div>
