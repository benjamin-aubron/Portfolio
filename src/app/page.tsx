  ...
  return (
    <div className="bg-black overflow-hidden">
      ...
      <section id="about" className="bg-black max-w-screen-lg mx-auto px-4 py-32 text-neutral-100">
        ...
        <div className="leading-8 py-2">Développeur front end junior, je maîtrise le Framework <span className="py-[3px] px-2 bg-neutral-950 border border-neutral-800 rounded-md">
