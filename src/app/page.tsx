...
export default function HomePage() {
  return (
    <div className="bg-black overflow-hidden">
      ...
      <section id="project" className="bg-black max-w-screen-xl mx-auto px-4 pt-32 lg:pt-20 pb-40 text-neutral-100">
      ...
      <h2 className="text-4xl text-neutral-100 font-semibold pb-6">A propos</h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam rem reiciendis consectetur saepe officiis animi aspernatur, ipsa nihil illo pariatur laudantium. Quis soluta quo, natus deleniti quasi amet officia eaque?</p>
        <p></p>
      </section>
