  ...
  return (
    <div className="bg-black overflow-hidden">
      ...
      <section className="bg-black max-w-screen-lg mx-auto px-4 pt-20 pb-80 text-neutral-100">
        ...
        <div className="text-center text-xl">Je me perfectionne en développement Front-end.</div>
        <div className="text-center text-xl">N'hésitez pas à me contacter pour discuter de votre projet ou de vos besoins.</div>
        <div className="flex flex-wrap items-center justify-center gap-3 md:gap-6 text-neutral-100 text-xl pt-4">
